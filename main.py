...
imgL = cv2.imread('chessboard_data/imgs/leftcamera/Im_L_1.png', 1)
imgR = cv2.imread('chessboard_data/imgs/rightcamera/Im_R_1.png', 1)
height , width = imgL.shape[0:2]
config = stereoconfig.stereoCamera()
imgL ,imgR = preprocess(imgL, imgR)  # 轉灰階
imgL = undistortion(imgL, config.cam_matrix_left, config.distortion_l)  # 消除distortion
imgR = undistortion(imgR, config.cam_matrix_right, config.distortion_r) # 消除distortion
